...
ActiveRecord::Schema.define(version: 2022_04_15_060430) do
  ...
  create_table "day_tasks", force: :cascade do |t|
    ...
    t.index ["schedule_day_id"], name: "index_day_tasks_on_schedule_day_id"
  ...
  create_table "schedule_days", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["task_id"], name: "index_schedule_days_on_task_id"
